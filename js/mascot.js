/* ============================================================
   NetKit Agent — drop-in pixel mascot for the sidebar
   Usage:
...
(() => {
  ...
  const CONFIG = {
    ...
    palette: { o:"#0a1f3d", r:"#2f6fe0", R:"#1c4fb7", k:"#06101a", g:"#5a9aff", d:"#07142a" },
    // Bubble theme
  ...
  function init() {
    ...
    if (!host) { console.warn("[netkit-mascot] mount not found:", CONFIG.mount); return; }
